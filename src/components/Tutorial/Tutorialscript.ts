...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    page: 'style',
    speaker: 'harper',
    harperText: "Before you send it out, add your SigiLites -people you trust to back you up. If you don't have any yet, don't worry. You can search for friends later under SigiLites in the Navigation Menu!",
    advanceOn: 'next',
    skippable: true,
    showOverlay: false,
  },
